...
const mainFunctions = {
    ...
    "contact": () => {
        ...
        contactContainer.href = `tel:${5743705813}`;
        contactContainer.innerHTML = `PHONE NUMBER: <br> +1 (574) 370 - 5813`
        main.appendChild(contactContainer);
    },
    "jobs": () => {
        section.replaceChildren();
        const jobsContainer = createElement("div", "jobsContainer width100 height100 flex flexColumn gap2 fontSize1 leftRightPadding2 centerText", "No positions currently available. Please check back later.");
